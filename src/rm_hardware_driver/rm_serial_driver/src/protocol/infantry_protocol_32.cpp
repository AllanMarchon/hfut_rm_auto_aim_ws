...
ProtocolInfantry32::ProtocolInfantry32(std::string_view port_name, bool enable_data_print) {
...
void ProtocolInfantry32::send(const rm_interfaces::msg::GimbalCmd &data) {
...
bool ProtocolInfantry32::receive(rm_interfaces::msg::SerialReceiveData &data) {
  FixedPacket<32> packet;
...
std::vector<rclcpp::SubscriptionBase::SharedPtr> ProtocolInfantry32::getSubscriptions(
...
std::vector<rclcpp::Client<rm_interfaces::srv::SetMode>::SharedPtr> ProtocolInfantry32::getClients(
