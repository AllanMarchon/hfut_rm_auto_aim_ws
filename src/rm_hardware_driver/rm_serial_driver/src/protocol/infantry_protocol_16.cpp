...
ProtocolInfantry16::ProtocolInfantry16(std::string_view port_name, bool enable_data_print) {
...
void ProtocolInfantry16::send(const rm_interfaces::msg::GimbalCmd &data) {
...
bool ProtocolInfantry16::receive(rm_interfaces::msg::SerialReceiveData &data) {
  FixedPacket<16> packet;
...
std::vector<rclcpp::SubscriptionBase::SharedPtr> ProtocolInfantry16::getSubscriptions(
...
std::vector<rclcpp::Client<rm_interfaces::srv::SetMode>::SharedPtr> ProtocolInfantry16::getClients(
