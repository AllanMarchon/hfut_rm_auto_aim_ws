...
#ifndef SERIAL_DRIVER_INFANTRY_PROTOCOL_16_HPP_
#define SERIAL_DRIVER_INFANTRY_PROTOCOL_16_HPP_

#include "rm_serial_driver/protocol.hpp"

namespace fyt::serial_driver::protocol {
// 步兵通信协议
class ProtocolInfantry16 : public Protocol {
public:
  explicit ProtocolInfantry16(std::string_view port_name, bool enable_data_print);

  ~ProtocolInfantry16() = default;
...
#endif  // SERIAL_DRIVER_INFANTRY_PROTOCOL_16_HPP_
