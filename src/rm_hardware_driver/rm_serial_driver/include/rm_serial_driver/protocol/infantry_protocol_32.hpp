...
#ifndef SERIAL_DRIVER_INFANTRY_PROTOCOL_32_HPP_
#define SERIAL_DRIVER_INFANTRY_PROTOCOL_32_HPP_

#include "rm_serial_driver/protocol.hpp"

namespace fyt::serial_driver::protocol {
// 步兵通信协议
class ProtocolInfantry32 : public Protocol {
public:
  explicit ProtocolInfantry32(std::string_view port_name, bool enable_data_print);

  ~ProtocolInfantry32() = default;
...
#endif  // SERIAL_DRIVER_INFANTRY_PROTOCOL_32_HPP_
